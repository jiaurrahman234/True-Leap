...
import com.app.trueleap.databinding.FragmentIndianLangBinding;
...
public class IndianLangFragment extends BaseFragment {

    FragmentIndianLangBinding binding;
    Context context;
    View v;

    public IndianLangFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v = inflater.inflate(R.layout.fragment_indian_lang, container, false);
    ...
    private void initdata() {
        if(languagelist.size()>0){
            for(int i=0; i <languagelist.size(); i++){
                if(languagelist.get(i).getLang_type()==LANG_INDIAN) {
